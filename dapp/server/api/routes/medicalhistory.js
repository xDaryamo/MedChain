...
// Condition Routes
router.post("/conditions", verifyToken, medicalHistoryController.createCondition);
router.get("/conditions/:id", verifyToken, medicalHistoryController.readCondition);
router.patch("/conditions/:id", verifyToken, medicalHistoryController.updateCondition);
router.delete("/conditions/:id", verifyToken, medicalHistoryController.deleteCondition);

// Procedure Routes
router.post("/procedures", verifyToken, medicalHistoryController.createProcedure);
router.get("/procedures/:id", verifyToken, medicalHistoryController.readProcedure);
router.patch("/procedures/:id", verifyToken, medicalHistoryController.updateProcedure);
router.delete("/procedures/:id", verifyToken, medicalHistoryController.deleteProcedure);
