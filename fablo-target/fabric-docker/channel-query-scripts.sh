...
printChannelsHelp() {
  ...
  echo "fablo channel list ospedalemaresca peer1"
  echo -e "\t List channels on 'peer1' of 'OspedaleMaresca'".
  echo ""
  ...
  echo "fablo channel list ospedaledelmare peer1"
  echo -e "\t List channels on 'peer1' of 'OspedaleDelMare'".
  echo ""
  ...
  echo "fablo channel list ospedalesgiuliano peer1"
  echo -e "\t List channels on 'peer1' of 'OspedaleSGiuliano'".
  echo ""
  ...
  echo "fablo channel list medicinageneralenapoli peer1"
  echo -e "\t List channels on 'peer1' of 'MedicinaGeneraleNapoli'".
  echo ""
  ...
  echo "fablo channel list neurologianapoli peer1"
  echo -e "\t List channels on 'peer1' of 'NeurologiaNapoli'".
  echo ""
  ...
  echo "fablo channel getinfo patient-records-channel ospedalemaresca peer1"
  echo -e "\t Get channel info on 'peer1' of 'OspedaleMaresca'".
  echo ""
  echo "fablo channel fetch config patient-records-channel ospedalemaresca peer1 [file-name.json]"
  echo -e "\t Download latest config block and save it. Uses first peer 'peer1' of 'OspedaleMaresca'".
  echo ""
  echo "fablo channel fetch <newest|oldest|block-number> patient-records-channel ospedalemaresca peer1 [file name]"
  echo -e "\t Fetch a block with given number and save it. Uses first peer 'peer1' of 'OspedaleMaresca'".
  echo ""
  ...
  echo "fablo channel getinfo patient-records-channel ospedaledelmare peer1"
  echo -e "\t Get channel info on 'peer1' of 'OspedaleDelMare'".
  echo ""
  echo "fablo channel fetch config patient-records-channel ospedaledelmare peer1 [file-name.json]"
  echo -e "\t Download latest config block and save it. Uses first peer 'peer1' of 'OspedaleDelMare'".
  echo ""
  echo "fablo channel fetch <newest|oldest|block-number> patient-records-channel ospedaledelmare peer1 [file name]"
  echo -e "\t Fetch a block with given number and save it. Uses first peer 'peer1' of 'OspedaleDelMare'".
  echo ""
  ...
  echo "fablo channel getinfo patient-records-channel ospedalesgiuliano peer1"
  echo -e "\t Get channel info on 'peer1' of 'OspedaleSGiuliano'".
  echo ""
  echo "fablo channel fetch config patient-records-channel ospedalesgiuliano peer1 [file-name.json]"
  echo -e "\t Download latest config block and save it. Uses first peer 'peer1' of 'OspedaleSGiuliano'".
  echo ""
  echo "fablo channel fetch <newest|oldest|block-number> patient-records-channel ospedalesgiuliano peer1 [file name]"
  echo -e "\t Fetch a block with given number and save it. Uses first peer 'peer1' of 'OspedaleSGiuliano'".
  echo ""
  ...
  echo "fablo channel getinfo patient-records-channel medicinageneralenapoli peer1"
  echo -e "\t Get channel info on 'peer1' of 'MedicinaGeneraleNapoli'".
  echo ""
  echo "fablo channel fetch config patient-records-channel medicinageneralenapoli peer1 [file-name.json]"
  echo -e "\t Download latest config block and save it. Uses first peer 'peer1' of 'MedicinaGeneraleNapoli'".
  echo ""
  echo "fablo channel fetch <newest|oldest|block-number> patient-records-channel medicinageneralenapoli peer1 [file name]"
  echo -e "\t Fetch a block with given number and save it. Uses first peer 'peer1' of 'MedicinaGeneraleNapoli'".
  echo ""
  ...
  echo "fablo channel getinfo patient-records-channel neurologianapoli peer1"
  echo -e "\t Get channel info on 'peer1' of 'NeurologiaNapoli'".
  echo ""
  echo "fablo channel fetch config patient-records-channel neurologianapoli peer1 [file-name.json]"
  echo -e "\t Download latest config block and save it. Uses first peer 'peer1' of 'NeurologiaNapoli'".
  echo ""
  echo "fablo channel fetch <newest|oldest|block-number> patient-records-channel neurologianapoli peer1 [file name]"
  echo -e "\t Fetch a block with given number and save it. Uses first peer 'peer1' of 'NeurologiaNapoli'".
  echo ""
  ...
  echo "fablo channel getinfo prescriptions-channel medicinageneralenapoli peer1"
  echo -e "\t Get channel info on 'peer1' of 'MedicinaGeneraleNapoli'".
  echo ""
  echo "fablo channel fetch config prescriptions-channel medicinageneralenapoli peer1 [file-name.json]"
  echo -e "\t Download latest config block and save it. Uses first peer 'peer1' of 'MedicinaGeneraleNapoli'".
  echo ""
  echo "fablo channel fetch <newest|oldest|block-number> prescriptions-channel medicinageneralenapoli peer1 [file name]"
  echo -e "\t Fetch a block with given number and save it. Uses first peer 'peer1' of 'MedicinaGeneraleNapoli'".
  echo ""
  ...
  echo "fablo channel getinfo prescriptions-channel neurologianapoli peer1"
  echo -e "\t Get channel info on 'peer1' of 'NeurologiaNapoli'".
  echo ""
  echo "fablo channel fetch config prescriptions-channel neurologianapoli peer1 [file-name.json]"
  echo -e "\t Download latest config block and save it. Uses first peer 'peer1' of 'NeurologiaNapoli'".
  echo ""
  echo "fablo channel fetch <newest|oldest|block-number> prescriptions-channel neurologianapoli peer1 [file name]"
  echo -e "\t Fetch a block with given number and save it. Uses first peer 'peer1' of 'NeurologiaNapoli'".
  echo ""
  ...
  echo "fablo channel getinfo lab-results-channel ospedalemaresca peer1"
  echo -e "\t Get channel info on 'peer1' of 'OspedaleMaresca'".
  echo ""
  echo "fablo channel fetch config lab-results-channel ospedalemaresca peer1 [file-name.json]"
  echo -e "\t Download latest config block and save it. Uses first peer 'peer1' of 'OspedaleMaresca'".
  echo ""
  echo "fablo channel fetch <newest|oldest|block-number> lab-results-channel ospedalemaresca peer1 [file name]"
  echo -e "\t Fetch a block with given number and save it. Uses first peer 'peer1' of 'OspedaleMaresca'".
  echo ""
  ...
  echo "fablo channel getinfo lab-results-channel medicinageneralenapoli peer1"
  echo -e "\t Get channel info on 'peer1' of 'MedicinaGeneraleNapoli'".
  echo ""
  echo "fablo channel fetch config lab-results-channel medicinageneralenapoli peer1 [file-name.json]"
  echo -e "\t Download latest config block and save it. Uses first peer 'peer1' of 'MedicinaGeneraleNapoli'".
  echo ""
  echo "fablo channel fetch <newest|oldest|block-number> lab-results-channel medicinageneralenapoli peer1 [file name]"
  echo -e "\t Fetch a block with given number and save it. Uses first peer 'peer1' of 'MedicinaGeneraleNapoli'".
  echo ""
  ...
  echo "fablo channel getinfo lab-results-channel neurologianapoli peer1"
  echo -e "\t Get channel info on 'peer1' of 'NeurologiaNapoli'".
  echo ""
  echo "fablo channel fetch config lab-results-channel neurologianapoli peer1 [file-name.json]"
  echo -e "\t Download latest config block and save it. Uses first peer 'peer1' of 'NeurologiaNapoli'".
  echo ""
  echo "fablo channel fetch <newest|oldest|block-number> lab-results-channel neurologianapoli peer1 [file name]"
  echo -e "\t Fetch a block with given number and save it. Uses first peer 'peer1' of 'NeurologiaNapoli'".
  echo ""
  ...
  echo "fablo channel getinfo emergency-channel ospedalemaresca peer1"
  echo -e "\t Get channel info on 'peer1' of 'OspedaleMaresca'".
  echo ""
  echo "fablo channel fetch config emergency-channel ospedalemaresca peer1 [file-name.json]"
  echo -e "\t Download latest config block and save it. Uses first peer 'peer1' of 'OspedaleMaresca'".
  echo ""
  echo "fablo channel fetch <newest|oldest|block-number> emergency-channel ospedalemaresca peer1 [file name]"
  echo -e "\t Fetch a block with given number and save it. Uses first peer 'peer1' of 'OspedaleMaresca'".
  echo ""
  ...
  echo "fablo channel getinfo emergency-channel ospedaledelmare peer1"
  echo -e "\t Get channel info on 'peer1' of 'OspedaleDelMare'".
  echo ""
  echo "fablo channel fetch config emergency-channel ospedaledelmare peer1 [file-name.json]"
  echo -e "\t Download latest config block and save it. Uses first peer 'peer1' of 'OspedaleDelMare'".
  echo ""
  echo "fablo channel fetch <newest|oldest|block-number> emergency-channel ospedaledelmare peer1 [file name]"
  echo -e "\t Fetch a block with given number and save it. Uses first peer 'peer1' of 'OspedaleDelMare'".
  echo ""
  ...
  echo "fablo channel getinfo emergency-channel ospedalesgiuliano peer1"
  echo -e "\t Get channel info on 'peer1' of 'OspedaleSGiuliano'".
  echo ""
  echo "fablo channel fetch config emergency-channel ospedalesgiuliano peer1 [file-name.json]"
  echo -e "\t Download latest config block and save it. Uses first peer 'peer1' of 'OspedaleSGiuliano'".
  echo ""
  echo "fablo channel fetch <newest|oldest|block-number> emergency-channel ospedalesgiuliano peer1 [file name]"
  echo -e "\t Fetch a block with given number and save it. Uses first peer 'peer1' of 'OspedaleSGiuliano'".
  echo ""

  echo "fablo channel getinfo public-health-channel ospedalemaresca peer0"
  echo -e "\t Get channel info on 'peer0' of 'OspedaleMaresca'".
  echo ""
  echo "fablo channel fetch config public-health-channel ospedalemaresca peer0 [file-name.json]"
  echo -e "\t Download latest config block and save it. Uses first peer 'peer0' of 'OspedaleMaresca'".
  echo ""
  echo "fablo channel fetch <newest|oldest|block-number> public-health-channel ospedalemaresca peer0 [file name]"
  echo -e "\t Fetch a block with given number and save it. Uses first peer 'peer0' of 'OspedaleMaresca'".
  echo ""

  echo "fablo channel getinfo public-health-channel ospedalemaresca peer1"
  echo -e "\t Get channel info on 'peer1' of 'OspedaleMaresca'".
  echo ""
  echo "fablo channel fetch config public-health-channel ospedalemaresca peer1 [file-name.json]"
  echo -e "\t Download latest config block and save it. Uses first peer 'peer1' of 'OspedaleMaresca'".
  echo ""
  echo "fablo channel fetch <newest|oldest|block-number> public-health-channel ospedalemaresca peer1 [file name]"
  echo -e "\t Fetch a block with given number and save it. Uses first peer 'peer1' of 'OspedaleMaresca'".
  echo ""

  echo "fablo channel getinfo public-health-channel ospedaledelmare peer0"
  echo -e "\t Get channel info on 'peer0' of 'OspedaleDelMare'".
  echo ""
  echo "fablo channel fetch config public-health-channel ospedaledelmare peer0 [file-name.json]"
  echo -e "\t Download latest config block and save it. Uses first peer 'peer0' of 'OspedaleDelMare'".
  echo ""
  echo "fablo channel fetch <newest|oldest|block-number> public-health-channel ospedaledelmare peer0 [file name]"
  echo -e "\t Fetch a block with given number and save it. Uses first peer 'peer0' of 'OspedaleDelMare'".
  echo ""

  echo "fablo channel getinfo public-health-channel ospedaledelmare peer1"
  echo -e "\t Get channel info on 'peer1' of 'OspedaleDelMare'".
  echo ""
  echo "fablo channel fetch config public-health-channel ospedaledelmare peer1 [file-name.json]"
  echo -e "\t Download latest config block and save it. Uses first peer 'peer1' of 'OspedaleDelMare'".
  echo ""
  echo "fablo channel fetch <newest|oldest|block-number> public-health-channel ospedaledelmare peer1 [file name]"
  echo -e "\t Fetch a block with given number and save it. Uses first peer 'peer1' of 'OspedaleDelMare'".
  echo ""

  echo "fablo channel getinfo public-health-channel ospedalesgiuliano peer0"
  echo -e "\t Get channel info on 'peer0' of 'OspedaleSGiuliano'".
  echo ""
  echo "fablo channel fetch config public-health-channel ospedalesgiuliano peer0 [file-name.json]"
  echo -e "\t Download latest config block and save it. Uses first peer 'peer0' of 'OspedaleSGiuliano'".
  echo ""
  echo "fablo channel fetch <newest|oldest|block-number> public-health-channel ospedalesgiuliano peer0 [file name]"
  echo -e "\t Fetch a block with given number and save it. Uses first peer 'peer0' of 'OspedaleSGiuliano'".
  echo ""

  echo "fablo channel getinfo public-health-channel ospedalesgiuliano peer1"
  echo -e "\t Get channel info on 'peer1' of 'OspedaleSGiuliano'".
  echo ""
  echo "fablo channel fetch config public-health-channel ospedalesgiuliano peer1 [file-name.json]"
  echo -e "\t Download latest config block and save it. Uses first peer 'peer1' of 'OspedaleSGiuliano'".
  echo ""
  echo "fablo channel fetch <newest|oldest|block-number> public-health-channel ospedalesgiuliano peer1 [file name]"
  echo -e "\t Fetch a block with given number and save it. Uses first peer 'peer1' of 'OspedaleSGiuliano'".
  echo ""

  echo "fablo channel getinfo public-health-channel medicinageneralenapoli peer0"
  echo -e "\t Get channel info on 'peer0' of 'MedicinaGeneraleNapoli'".
  echo ""
  echo "fablo channel fetch config public-health-channel medicinageneralenapoli peer0 [file-name.json]"
  echo -e "\t Download latest config block and save it. Uses first peer 'peer0' of 'MedicinaGeneraleNapoli'".
  echo ""
  echo "fablo channel fetch <newest|oldest|block-number> public-health-channel medicinageneralenapoli peer0 [file name]"
  echo -e "\t Fetch a block with given number and save it. Uses first peer 'peer0' of 'MedicinaGeneraleNapoli'".
  echo ""

  echo "fablo channel getinfo public-health-channel medicinageneralenapoli peer1"
  echo -e "\t Get channel info on 'peer1' of 'MedicinaGeneraleNapoli'".
  echo ""
  echo "fablo channel fetch config public-health-channel medicinageneralenapoli peer1 [file-name.json]"
  echo -e "\t Download latest config block and save it. Uses first peer 'peer1' of 'MedicinaGeneraleNapoli'".
  echo ""
  echo "fablo channel fetch <newest|oldest|block-number> public-health-channel medicinageneralenapoli peer1 [file name]"
  echo -e "\t Fetch a block with given number and save it. Uses first peer 'peer1' of 'MedicinaGeneraleNapoli'".
  echo ""

  echo "fablo channel getinfo public-health-channel neurologianapoli peer0"
  echo -e "\t Get channel info on 'peer0' of 'NeurologiaNapoli'".
  echo ""
  echo "fablo channel fetch config public-health-channel neurologianapoli peer0 [file-name.json]"
  echo -e "\t Download latest config block and save it. Uses first peer 'peer0' of 'NeurologiaNapoli'".
  echo ""
  echo "fablo channel fetch <newest|oldest|block-number> public-health-channel neurologianapoli peer0 [file name]"
  echo -e "\t Fetch a block with given number and save it. Uses first peer 'peer0' of 'NeurologiaNapoli'".
  echo ""

  echo "fablo channel getinfo public-health-channel neurologianapoli peer1"
  echo -e "\t Get channel info on 'peer1' of 'NeurologiaNapoli'".
  echo ""
  echo "fablo channel fetch config public-health-channel neurologianapoli peer1 [file-name.json]"
  echo -e "\t Download latest config block and save it. Uses first peer 'peer1' of 'NeurologiaNapoli'".
  echo ""
  echo "fablo channel fetch <newest|oldest|block-number> public-health-channel neurologianapoli peer1 [file name]"
  echo -e "\t Fetch a block with given number and save it. Uses first peer 'peer1' of 'NeurologiaNapoli'".
  echo ""

  echo "fablo channel getinfo public-health-channel farmaciapetrone peer0"
  echo -e "\t Get channel info on 'peer0' of 'FarmaciaPetrone'".
  echo ""
  echo "fablo channel fetch config public-health-channel farmaciapetrone peer0 [file-name.json]"
  echo -e "\t Download latest config block and save it. Uses first peer 'peer0' of 'FarmaciaPetrone'".
  echo ""
  echo "fablo channel fetch <newest|oldest|block-number> public-health-channel farmaciapetrone peer0 [file name]"
  echo -e "\t Fetch a block with given number and save it. Uses first peer 'peer0' of 'FarmaciaPetrone'".
  echo ""

  echo "fablo channel getinfo public-health-channel farmaciacarbone peer0"
  echo -e "\t Get channel info on 'peer0' of 'FarmaciaCarbone'".
  echo ""
  echo "fablo channel fetch config public-health-channel farmaciacarbone peer0 [file-name.json]"
  echo -e "\t Download latest config block and save it. Uses first peer 'peer0' of 'FarmaciaCarbone'".
  echo ""
  echo "fablo channel fetch <newest|oldest|block-number> public-health-channel farmaciacarbone peer0 [file name]"
  echo -e "\t Fetch a block with given number and save it. Uses first peer 'peer0' of 'FarmaciaCarbone'".
  echo ""

  echo "fablo channel getinfo public-health-channel laboratorioanalisicmo peer0"
  echo -e "\t Get channel info on 'peer0' of 'LaboratorioAnalisiCMO'".
  echo ""
  echo "fablo channel fetch config public-health-channel laboratorioanalisicmo peer0 [file-name.json]"
  echo -e "\t Download latest config block and save it. Uses first peer 'peer0' of 'LaboratorioAnalisiCMO'".
  echo ""
  echo "fablo channel fetch <newest|oldest|block-number> public-health-channel laboratorioanalisicmo peer0 [file name]"
  echo -e "\t Fetch a block with given number and save it. Uses first peer 'peer0' of 'LaboratorioAnalisiCMO'".
  echo ""

  echo "fablo channel getinfo public-health-channel laboratorioanalisisdn peer0"
  echo -e "\t Get channel info on 'peer0' of 'LaboratorioAnalisiSDN'".
  echo ""
  echo "fablo channel fetch config public-health-channel laboratorioanalisisdn peer0 [file-name.json]"
  echo -e "\t Download latest config block and save it. Uses first peer 'peer0' of 'LaboratorioAnalisiSDN'".
  echo ""
  echo "fablo channel fetch <newest|oldest|block-number> public-health-channel laboratorioanalisisdn peer0 [file name]"
  echo -e "\t Fetch a block with given number and save it. Uses first peer 'peer0' of 'LaboratorioAnalisiSDN'".
  echo ""
